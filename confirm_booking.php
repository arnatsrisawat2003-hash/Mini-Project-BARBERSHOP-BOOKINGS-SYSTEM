...
// ดึงข้อมูลการจองที่มีสถานะเป็น 'confirmed' สำหรับช่างที่ล็อกอิน
$sql_bookings = "
    SELECT 
        b.booking_id,
    ...
    WHERE b.barber_id = ? AND b.status = 'confirmed'
...
<body class="sub_page">
  ...
  <div class="container">
    <div class="booking-section">
        ...
        <?php else: ?>
            <p class="text-center">ไม่มีรายการการจองที่ยืนยันแล้ว</p>
        <?php endif; ?>
    </div>
</div>
