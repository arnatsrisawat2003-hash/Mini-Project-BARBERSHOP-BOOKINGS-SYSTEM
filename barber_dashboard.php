...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['confirm_booking'])) {
    ...
    if ($stmt->execute()) {
        $success_message = "ยืนยันการจองสำเร็จ!";
    } else {
        $error_message = "เกิดข้อผิดพลาดในการยืนยันการจอง";
    }
}

// ดึงข้อมูลการจองสำหรับช่างที่ล็อกอิน
$sql_bookings = "
    SELECT 
        b.booking_id,
          ...
          <nav class="navbar navbar-expand-lg custom_nav-container">
            ...
            <div class="collapse navbar-collapse ml-auto" id="navbarSupportedContent">
              <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="barber_profile.php?user_id=<?php echo $_SESSION['user_id']; ?>"><?php echo htmlspecialchars($email); ?></a>
                </li>
                <li class="nav-item">
                    ...
                    <tr>
                      ...
                      <td>
                        <form method="POST">
                          ...
                          <button type="submit" class="btn btn-success" name="confirm_booking">Confirm</button>
                        </form>
                      </td>
                    </tr>
                  <?php endwhile; ?>
