    ...
    <div class="container">
        ...
        <div class="row">
            ...
            while ($row = $result->fetch_assoc()) { 
                // ตรวจสอบว่ามีภาพหรือไม่ ถ้าไม่มีให้ใช้ภาพเริ่มต้น
                $image_path = !empty($row['image']) ? 'img/service/' . $row['image'] : 'img/default_service.png'; 
            ?>
            <div class="col-sm-6 col-md-4">
                <a href="choose_service.php?type_id=<?php echo $row['type_id']; ?>" style="text-decoration: none; color: black;">
                    <div class="box">
                        <div class="img-box">
                            <img src="<?php echo $image_path; ?>" alt="Service Image" />
                        </div>
                        <div class="detail-box">
                            <h5><?php echo htmlspecialchars($row['type_name']); ?></h5>
